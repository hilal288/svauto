...
packer_build_cs()
{
	...
	./svauto.sh --packer-builder --base-os=centos7 --product=svsde --version=$SDE_VERSION --product-variant=cs-1 --qcow2 --ova --vhd --vm-xml --sha256sum \
		...
		--ansible-inventory-builder="svbox,localhost,ansible_connection=local,base_os=centos7,deployment_mode=yes,sandvine_yum_repo=$STATIC_PACKAGES_SERVER,svauto_yum_url=$SVAUTO_MAIN_HOST,release_code_name=$RELEASE_CODE_NAME" \
	...
	./svauto.sh --packer-builder --base-os=centos6 --product=svsde --version=$SDE_VERSION --product-variant=cs-1 --qcow2 --ova --vhd --vm-xml --sha256sum \
		--ansible-remote-user="root" \
		--ansible-inventory-builder="svbox,localhost,ansible_connection=local,base_os=centos6,deployment_mode=yes,sandvine_yum_repo=$STATIC_PACKAGES_SERVER,svauto_yum_url=$SVAUTO_MAIN_HOST,release_code_name=$RELEASE_CODE_NAME" \
...
#		--ansible-remote-user="root" \
#		--ansible-inventory-builder="svbox,localhost,ansible_connection=local,base_os=centos6,deployment_mode=yes" \
#	        --ansible-playbook-builder="svbox,centos-xen,cloud-init,bootstrap;base_os_upgrade=yes,grub-conf,base-os-auto-config,centos-network-setup;activate_eth1=no,centos-firewall-setup,golang-env,vmware-tools,post-cleanup-image" $DRY_RUN_OPT
...
#		--ansible-remote-user="root" \
#		--ansible-inventory-builder="svbox,localhost,ansible_connection=local,base_os=centos6,deployment_mode=yes" \
#	        --ansible-playbook-builder="svbox,centos-xen,cloud-init,bootstrap;base_os_upgrade=yes,grub-conf,base-os-auto-config,centos-network-setup;activate_eth1=no,centos-firewall-setup,nodejs-env,vmware-tools,post-cleanup-image" $DRY_RUN_OPT
...
#		--ansible-remote-user="root" \
#		--ansible-inventory-builder="svbox,localhost,ansible_connection=local,base_os=centos7,deployment_mode=yes" \
#	        --ansible-playbook-builder="svbox,centos-xen,cloud-init,bootstrap;base_os_upgrade=yes,grub-conf,udev-rules,base-os-auto-config,centos-network-setup;activate_eth1=no,centos-firewall-setup,golang-env,vmware-tools,post-cleanup-image" $DRY_RUN_OPT
...
#		--ansible-remote-user="root" \
#		--ansible-inventory-builder="svbox,localhost,ansible_connection=local,base_os=centos7,deployment_mode=yes" \
#	        --ansible-playbook-builder="svbox,centos-xen,cloud-init,bootstrap;base_os_upgrade=yes,grub-conf,udev-rules,base-os-auto-config,centos-network-setup;activate_eth1=no,centos-firewall-setup,nodejs-env,vmware-tools,post-cleanup-image" $DRY_RUN_OPT
