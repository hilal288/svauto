...
echo
echo "Welcome to OpenStack Newton Deployment!"
echo
...
./svauto.sh --operation=openstack --base-os=ubuntu16 --ubuntu-network-detect-default-nic --os-release=newton --os-aio --os-bridge-mode=OVS --ansible-extra-vars="deployment_mode=yes"
